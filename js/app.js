(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".main-block-home__slider")) new core(".main-block-home__slider", {
                modules: [ Navigation, Parallax, Pagination, Lazy, Autoplay, Keyboard ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                spaceBetween: 20,
                ...
                pagination: {
                    el: ".slider-main-block-home-slide__swiper-pagination",
                    clickable: true
                },
                navigation: {
                    prevEl: ".slider-main-block-home-slide__swiper-button-prev",
                    nextEl: ".slider-main-block-home-slide__swiper-button-next"
                },
                on: {}
            });
            if (document.querySelector(".vacancies-item__slider")) new core(".vacancies-item__slider", {
                ...
                navigation: {
                    prevEl: ".vacancies-item__swiper-button-prev",
                    nextEl: ".vacancies-item__swiper-button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1
            ...
            if (document.querySelector(".images-product")) {
                var subSlider = new core(".sub-product-slider", {
                    modules: [ Navigation, Lazy, Keyboard, Thumb, freeMode ],
                    spaceBetween: 15,
                    slidesPerView: 3,
                    freeMode: true,
                    watchSlidesProgress: true,
                ...
                new core(".main-product-slider", {
                    modules: [ Navigation, Lazy, Keyboard, Thumb, freeMode, EffectFade ],
                    spaceBetween: 10,
                    lazy: true,
                    observer: true,
                    observeParents: true,
                    ...
                    navigation: {
                        prevEl: ".images-product__swiper-button-prev",
                        nextEl: ".images-product__swiper-button-next"
                    },
                    keyboard: {
                        enabled: true,
                        onlyInViewport: false
        ...
        window.onload = function() {
            if (isMobile.any()) {
                let menuParents = document.querySelectorAll(".catalog-main-block-home__parent>a");
                ...
                let creditChoose = document.querySelector(".credit-product__button");
                if (creditChoose) {
                    const creditList = document.querySelector(".credit-product__block");
                    creditChoose.addEventListener("click", (function(e) {
                        creditList.classList.toggle("_active");
                        e.preventDefault();
                    }));
                }
            } else {
                let menuParents = document.querySelectorAll(".catalog-main-block-home__parent");
                for (let index = 0; index < menuParents.length; index++) {
                    const menuParent = menuParents[index];
                ...
                if (creditChoose) {
                    const creditList = document.querySelector(".credit-product__block");
                    creditChoose.addEventListener("mouseenter", (function(e) {
                        creditList.classList.add("_active");
                        e.preventDefault();
                    }));
                    creditChoose.addEventListener("mouseleave", (function(e) {
                        creditList.classList.remove("_active");
                    }));
                    creditList.addEventListener("mouseenter", (function(e) {
                        creditList.classList.add("_active");
                    }));
                    creditList.addEventListener("mouseleave", (function(e) {
                        creditList.classList.remove("_active");
                    }));
                }
            }
            if (document.querySelector(".form-vacancies")) {
                var formPhone = document.getElementById("phone");
                var maskForm = {
                    mask: "+38 (000) 000-00-00",
                    lazy: true
                };
                new IMask(formPhone, maskForm);
            }
            ...
            function documentActions(e) {
                ...
                if (targetElement.classList.contains("actions-header__cart") || targetElement.closest(".actions-header__cart")) {
                    if (document.querySelector(".cart-header__list").children.length > 0) document.querySelector(".cart-header__body").classList.toggle("_active");
                    e.preventDefault();
                } else if (!targetElement.closest(".cart-header__body") && !targetElement.classList.contains("actions-product__button")) document.querySelector(".cart-header__body").classList.remove("_active");
                if (targetElement.classList.contains("cart-list__button-delete")) {
                    const productId = targetElement.closest(".cart-list__item").dataset.cartPid;
                    updateCart(targetElement, productId, false);
                    e.preventDefault();
                }
                if (targetElement.classList.contains("_tab-active")) {
                    let tabTitleName = document.querySelector("._tab-active span");
                    let breadcrumbsCurrent = document.querySelector(".breadcrumbs__item-tab > a");
                    breadcrumbsCurrent.innerHTML = tabTitleName.innerHTML;
                }
            }
            function addToCart(productButton, productId) {
                if (!productButton.classList.contains("_hold")) {
                    ...
                    const cart = document.querySelector(".actions-header__block");
            ...
            function updateCart(productButton, productId, productAdd = true) {
                const cart = document.querySelector(".actions-header__block");
                const cartIcon = cart.querySelector(".actions-header__cart");
                ...
                if (productAdd) {
                    ...
                    if (!cartProduct) {
                        ...
                        const cartProductContent = `\n\t\t\t<button class="cart-list__button cart-list__button-delete _icon-delete"></button>\n\t\t\t<div class="cart-list__image cart-list__image-ibg"><a href="" class="cart-list__link">${cartProductImage}</a></div>\n\t\t\t<div class="cart-list__body">\n\t\t\t<div class="cart-list__title"><a href="">${cartProductTitle}</a></div>\n\t\t\t<div class="cart-list__info info-cart-list">\n\t\t\t\t<div class="info-cart-list__quantity"><span>1 </span> x</div>\n\t\t\t\t<div class="info-cart-list__price grn">${cartProductPrice}</div>\t\t\t\t\t\t\t\t\n\t\t\t</div>\n\t\t\t\n\t\t</div>`;
                        cartList.insertAdjacentHTML("beforeend", `<li data-cart-pid="${productId}" class="cart-list__item">${cartProductContent}</li>`);
                    } else {
                        const cartProductQuantity = cartProduct.querySelector(".info-cart-list__quantity span");
            ...
            if (calcForm) {
                const calcButton = document.querySelector(".data-calculate__button");
                calcButton.addEventListener("click", (function(e) {
                    const inputSquare = document.querySelector("#input-square");
                    const squareText = document.querySelector(".text-square");
                    const radioType = document.querySelectorAll('input[name="type"]');
                    const radioCondition = document.querySelectorAll('input[name="current-condition"]');
                    const radioResult = document.querySelectorAll('input[name="result"]');
                    squareText.innerHTML = inputSquare.value;
                    const basePrice = 1e4;
                    const totalPriceElement = document.querySelector(".total-price");
                    function calculate() {
                        let totalPrice = basePrice * (parseInt(inputSquare.value) / 20);
                        for (const radio of radioType) if (radio.checked) totalPrice *= parseFloat(radio.value);
                        for (const radio of radioCondition) if (radio.checked) totalPrice *= parseFloat(radio.value);
                        for (const radio of radioResult) if (radio.checked) totalPrice *= parseFloat(radio.value);
                        const formatter = new Intl.NumberFormat("ua");
                        totalPriceElement.innerText = formatter.format(totalPrice);
                    }
                    calculate();
                    squareText.classList.add("_calc");
                    totalPriceElement.classList.add("_calc");
                    setTimeout(delName, 1500);
                    function delName() {
                        squareText.classList.remove("_calc");
                        totalPriceElement.classList.remove("_calc");
                    }
                }));
            }
        };
